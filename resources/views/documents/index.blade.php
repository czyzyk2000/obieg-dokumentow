                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-yellow-700">
                                <strong>{{ $pendingCount }}</strong> {{ $pendingCount === 1 ? 'dokument czeka' : 'dokumentów czeka' }} na Twoją akceptację
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                                    ...
                                    @foreach($documents as $document)
                                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <div class="text-xs text-gray-500">{{ $document->user->role->label() }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-semibold text-gray-900">{{ $document->formatted_amount }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Zacznij od utworzenia nowego dokumentu.</p>
                            @can('create', App\Models\Document::class)
                                <div class="mt-6">
                                    <a href="{{ route('documents.create') }}" 
